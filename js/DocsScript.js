...
import productsJson from '../jsonDocs/products.json' assert {type:"json"}
import paymentJSON from '../jsonDocs/payment.json' assert {type:"json"}
import cartAndOrderJson from '../jsonDocs/cartAndOrders.json' assert {type:"json"}
